...
/**
 * Movie or TV media information included in a TMDB credit response.
 *
 ...
 * @property character character name for cast credits
 * @property seasons TV seasons
 */
@JvmRecord
data class CreditMedia(
    ...
    val seasons: List<CreditSeason> = emptyList()
) : TmdbModel