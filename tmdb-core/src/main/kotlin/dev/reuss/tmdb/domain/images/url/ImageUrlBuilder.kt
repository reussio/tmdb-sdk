...
interface ImageUrlBuilder {
    ...
    fun poster(path: String, size: PosterSize): URI

    fun backdrop(path: String, size: BackdropSize): URI

    fun logo(path: String, size: LogoSize): URI

    fun profile(path: String, size: ProfileSize): URI

    fun still(path: String, size: StillSize): URI
}