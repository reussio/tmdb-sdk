...
internal class DefaultTvSeriesService(
    ...
    override fun screenedTheatrically(seriesId: TvShowId): TvSeriesScreenedTheatrically =
        httpClient.get(
    ...
    override fun images(seriesId: TvShowId): TvShowImages = images(seriesId, ImageQuery.none())
