 ...
 * @param character        character name for cast credits
 * @param seasons          TV seasons
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public record CreditMedia(
        boolean adult,
