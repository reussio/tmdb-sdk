...
class TmdbInvalidRegionValidationTest {
    @Test
    fun shouldFailWhenDefaultRegionIsInvalid() {
    }
        ...
        val app =
            QuarkusExtensionTest()
                .withApplicationRoot { jar ->
                    ...
                    assertTrue(
                        containsMessage(throwable, "Unknown ISO 3166-1 alpha-2 region: ZZ"),
                        "Expected invalid region message but got: $throwable",
                    )
                }
