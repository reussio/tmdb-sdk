...
class TmdbInvalidBaseUrlValidationTest {
    @Test
    fun shouldFailWhenBaseUrlIsNotAnAbsoluteHttpUrl() {
    }
        ...
        val app =
            QuarkusExtensionTest()
                .withApplicationRoot { jar ->
                    ...
                    assertTrue(
                        containsMessage(throwable, "TMDB base URL must be an absolute HTTP(S) URL"),
                        "Expected invalid base URL message but got: $throwable",
                    )
                }
